...
All the required assets for this project are in the `/images` folder. The images are already exported for the correct screen size and optimized.
...
Submit your solution by pushing to github, hosting on github pages and sharing the link on the whatsapp group.
